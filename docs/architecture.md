...
cad/
  ...
  sync_params.py    ← params.csv / params-table.csv → FreeCAD
```
...
- [ ] Run `cad/sync_params.py` inside FreeCAD to update geometry (`sync_table()` after adding or removing a model)
